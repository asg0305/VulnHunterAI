...
query_bar = html.Div([
    dcc.Input(id='queryInput', type='text', placeholder='Ejemplo: CVE.cve=\'CVE-XXXX-YYYY\' and URL.url=\'vulmon.com\'', value='', style={'width': '60%', 'padding': '0.5rem', 'margin': '10px auto'}),
